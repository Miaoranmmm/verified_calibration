...
class DebertaV2ForSequenceClassificationCalibrated(DebertaV2ForSequenceClassification):
    def __init__(self, config):
        super().__init__(config)
        ...
        # calibration
        self.calibrator = cal.PlattBinnerMarginalCalibrator(7, num_bins=num_bins, way="new")
